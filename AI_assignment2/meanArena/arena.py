...
import config
import os #imported to allow a change of directory
class Arena():
    #Added this into the graphics script because it prevented code from running using f5 once pushed to git, resolved with changing current directory using
